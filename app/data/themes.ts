...
export const themes: Theme[] = [
  {
    ...
    position: { x: -30, y: -10 },
    subthemes: [
      { id: "transicion-lugar-origen", title: "Transición desde lugar de origen", highlights: 156 },
      { id: "costos-bienes-servicios", title: "Costos de bienes y servicios", highlights: 134 },
  ...
  },
  {
    ...
    subthemes: [
      ...
      { id: "ruido-volumen", title: "Ruido y música a alto volumen", highlights: 87 },
      { id: "espacios-comunes", title: "Uso de espacios comunes", highlights: 76 },
      { id: "administraciones", title: "Administraciones y vivienda horizontal", highlights: 65 },
      { id: "solucion-conflictos", title: "Solución de conflictos", highlights: 54 },
  ...
  },
  {
    ...
    subthemes: [
      ...
      { id: "recreacion-deporte", title: "Recreación y deporte", highlights: 89 },
  ...
  },
  {
    ...
    subthemes: [
      ...
      { id: "servicios-publicos", title: "Servicios públicos básicos", highlights: 65 },
      { id: "conectividad-digital", title: "Internet y comunicaciones", highlights: 52 },
    ],
  },
  {
    id: "seguridad",
    ...
    position: { x: -90, y: -110 },
    subthemes: [
      { id: "consumo-problemático-sustancias", title: "Consumo problemático de sustancias", highlights: 89 },
      { id: "robos", title: "Robos", highlights: 76 },
      { id: "servicios-vigilancia", title: "Servicios de vigilancia", highlights: 54 },
  ...
  },
  {
    ...
    position: { x: -130, y: 90 },
    subthemes: [
      { id: "oferta-rutas", title: "Oferta, horarios y frecuencias", highlights: 78 },
      { id: "costos", title: "Costos de transporte", highlights: 56 },
      { id: "transporte-pirata", title: "Transporte ilegal/pirata", highlights: 45 },
  ...
  },
  {
    ...
    subthemes: [
      ...
      { id: "personas-discapacidad", title: "Personas con discapacidad", highlights: 27 },
    ],
  },
  {
    id: "gobernanza",
    ...
    subthemes: [
      { id: "gestion-institucional", title: "Gestión institucional", highlights: 45 },
      { id: "participacion-comunitaria", title: "Participación comunitaria", highlights: 32 },
